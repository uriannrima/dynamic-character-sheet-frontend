    ...
    <tr>
        ...
        <td style="width: 55%">
            ...
            <div style="display:inline-block">
                ...
                <input type="number" class="attribute-field" style="display:block" readonly v-bind:value="savingThrow.base">
            </div>
            <span>+</span>
            <div style="display:inline-block">
                <label for="" style="display:block; margin-top:-25px; font-size:12px" v-if="firstRow">Ability</label>
                <input type="number" class="attribute-field" style="display:block" readonly v-bind:value="savingThrow.abilityModifier">
            </div>
            <span>+</span>
            <div style="display:inline-block">
                <label for="" style="display:block; margin-top:-25px; font-size:12px" v-if="firstRow">Magic</label>
                <input type="number" class="attribute-field" style="display:block" readonly v-bind:value="savingThrow.magicModifier">
            </div>
            <span>+</span>
            <div style="display:inline-block">
