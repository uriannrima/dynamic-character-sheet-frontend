    ...
    <div>
        <div id="main-content" class="main-container">
            <div id="character-sheet" class="character-sheet">
                <div v-show="sheetPage == 1 || sheetPage == -1" class="page first-page">
                    <div class="pure-g">
                        ...
                        <div class="pure-u-1-1 pure-u-lg-9-24">
                            <skills-container :character="character" :add:enabled="false" @onSkillAdded="addToCharacter('skills', $event)" @onSkillRemoved="removeFromCharacter('skills', $event)" @onSkillUpdated="updateOnCharacter('skills', $event)"></skills-container>
                        </div>
                    </div>
                </div>
                <div v-show="sheetPage == 2 || sheetPage == -1" class="page second-page">
                    <div class="padding-box">
                        <div class="pure-g">
                                ...
                                <div class="left-container">
                                    ...
                                    <div class="gear-container">
                                        ...
                                        <div class="vue-repeater" v-for="(protectiveItem, index) in character.gear.protectiveItems" :key="index">
                                            <div class="protective-item-container">
                                                <div>
                                ...
                                <div class="pure-g">
                                    ...
                                    <div class="pure-u-3-5">
                                        <div class="third-region">
                                            <spells-container :character="character" :add-enabled="false" @onSpellAdded="addSpell" @onSpellRemoved="removeSpell"></spells-container>
