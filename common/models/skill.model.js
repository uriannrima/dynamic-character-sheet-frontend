...
exports.DEFAULT_SKILLS = [
    ...
    new skill({ name: 'Craft', keyAbility: 'intelligence', untrained: true, armorCheckPenalty: true, subValue: true, }),
    ...
    new skill({ name: 'Knowledge', keyAbility: 'intelligence', untrained: false, armorCheckPenalty: false, subValue: true }),
    ...
    new skill({ name: 'Perform', keyAbility: 'charisma', untrained: false, armorCheckPenalty: false, subValue: true }),
    new skill({ name: 'Profession', keyAbility: 'wisdom', untrained: false, armorCheckPenalty: false, subValue: true }),
