  ...
  <div class="skill-form-component">
    ...
    <div v-else>
      ...
      <div class="skill-form-component-html-container">
        ...
        <textarea class="skill-aditional-information-text-area" v-if="has.aditionalInformation || skill.aditionalInformation" type="text" v-model.trim="skill.aditionalInformation"></textarea>
      </div>
    </div>
  </div>
</template>
