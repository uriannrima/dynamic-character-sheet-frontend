...
export { default as AbilitiesScoreComponent } from './abilities-score.component';

export { default as HealthComponent } from './health.component';
export { default as PrimaryArmorComponent } from './primary-armor.component';
