<template>
    <div class="primary-armor-component">
        ...
        <label>&nbsp;</label>
        <label class="lg-h-down total-label">Total</label>
        <label class="lg-h-down">&nbsp;</label>
        ...
        <div class="lg-h-up black-box damage-reduction-bb">
...
>>>>>>> 80b80fa0c73047458740802b81dbabe1a23215fd
</style>
